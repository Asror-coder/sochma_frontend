            ...
            <div class="flex justify-center">
                <div class="w-4/12 bg-white p-6 rounded-lg">
                    ...
                    <form action="" @submit.prevent="validateLogin">
                        <div class="mb-4">
                            <label for="loginName" class="sr-only">Login</label>
                            <input
                                type="text"
                                name="loginName"
                                id="loginName"
                                ...
                                v-model="loginName"
                                :class="{'border-red-500': errors.loginName}"
                            >
                            <span v-if="errors.loginName" class="text-red-500 text-sm">{{ errors.loginName }}</span>
                        </div>
